...
class SingletonClassExample {
	...
	// declaring an instance of class SingletonClassExample which is null
	// initially means not initialized.
	
	private static SingletonClassExample instanceOfSingletonClassExample = null;

	// Declaring constructor as private to restrict object creation outside of
	// class
